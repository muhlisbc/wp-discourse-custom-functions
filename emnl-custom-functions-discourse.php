<?php
/**
 * Plugin Name: WP-Discourse - Custom Functions
 * Description: Custom functions for Discourse plugin.
...
/*-----------------------------------------------------------------------------------*/
/* Removes Discourse link previews (oneboxes) and images. Outputs a plain text link.
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* Shortening content of Discourse replies below Wordpress posts. Outputs clean HTML.
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* Discourse custom message for new created topics for new published posts
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* Discourse notification and link below posts when NO Replies are posted in forum
/*-----------------------------------------------------------------------------------*/
...
function my_namespace_no_replies_html ( $input ) {
	...
	<div id="comments" class="comments-area">
		<div class="respond comment-respond">
			<p id="reply-title" class="comment-reply-title">Ask a question or start a discussion by visiting our <a href="{topic_url}" target="_blank">Community Forum</a></p>
		</div>
	</div>
    <?php
    $output = ob_get_clean();
...
/*-----------------------------------------------------------------------------------*/
/* Content of Discourse replies below post without the Participants section
/*-----------------------------------------------------------------------------------*/
...
function emnl_remove_participants_html( $input ) {
    ...
    <div id="comments" class="comments-area discourse-comments-area">
        ...
        <div class="respond comment-respond">
            <p id="reply-title" class="comment-reply-title"><strong><a href="{topic_url}" target="_blank">{more_replies}</a></strong> Ask a question or join the discussion by visiting our <a href="{topic_url}" target="_blank">Community Forum</a></p>
        </div>
    </div>
    <?php
    $output = ob_get_clean();
...
add_filter( 'discourse_replies_html', 'emnl_remove_participants_html' );
